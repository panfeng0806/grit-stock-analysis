...
>
> **v1.6** · 2026-05-07 清理重复规则 · 安克创新 300866.SZ 全流程验证
...
```bash
# 1. 解密（需要密码）
age -d grit-v1.6.tar.gz.age | tar xz
...
> 完整细则见 `grit-stock-analysis/SKILL.md` 末尾 Pitfalls 14-19。
...
<p align="center">
  <sub>Agent-agnostic · GRIT Framework v1.6 · 2026</sub>
</p>
